...
(require "ast.rkt" "types.rkt" "compile-ops.rkt" "gc.rkt" "utils.rkt" a86/ast)
...
(define (compile p)
    (match p
      ...
      (prog (externs)
            ...
            (Push stack-begin)	   ; mark the beginning of the stack (to know when to stop during gc root traversal)
            (Mov rbx rdi)          ; recv heap pointer
            (compile-e e '() #f)
            (Add rsp 8)            ; pop the stack-begin
